...
class RenderSystem {
	...
	const std::array<std::string, texture_count> texture_paths = {
			...
			textures_path("pinball_background1.png"),
			textures_path("pinball_background2.png"),
			textures_path("pinball_background3.png"),
			textures_path("pinball_background4.png"),
			textures_path("pinball_background5.png"),
			textures_path("pinball_background6.png"),
			textures_path("pinball_background7.png"),
			textures_path("pinball_background8.png"),
