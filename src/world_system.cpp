...
void WorldSystem::restart_game() {
	...
	Entity rectangle = createPolygonByVertex(renderer, { {220, 350}, { 220,220 }, { 350,220 }, { 350,350 } }, GEOMETRY_BUFFER_ID::RECT);
	...
	Entity enemy = createEnemy(renderer, { 400, 200 });
	registry.colors.insert(enemy, { 1, 0, 0 });
