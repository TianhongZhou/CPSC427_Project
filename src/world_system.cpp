...
void WorldSystem::init_combat() {
    ...
    Entity rectangle2 = createPolygonByVertex(renderer, {{220, 350},
                                                         {220, 220},
                                                         {300, 220},
                                                         {300, 350}}, GEOMETRY_BUFFER_ID::OCT);
    ...
    Entity rectangle = createPolygonByVertex(renderer, {{220, 350},
                                                        {220, 220},
                                                        {400, 220},
                                                        {400, 350}}, GEOMETRY_BUFFER_ID::RECT);

    createNewRectangleTiedToEntity(rectangle, 180.f, 130.f,
                                   registry.motions.get(rectangle).position - vec2(0.0, 150.0));
